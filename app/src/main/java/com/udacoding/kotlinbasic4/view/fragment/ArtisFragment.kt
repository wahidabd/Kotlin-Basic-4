...
import com.udacoding.kotlinbasic4.databinding.FragmentArtisBinding
...
class ArtisFragment : Fragment(), PresenterView {

    private var presenter: Presenter? = null
    private var _binding: FragmentArtisBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentArtisBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvArtis.layoutManager = LinearLayoutManager(context)
    ...
    override fun onSuccess(article: ArrayList<ArticlesItems>) {
        ...
        binding.rvArtis.adapter = adapter
